...
public protocol DataTransferService {
    ...
    func request<E: ResponseRequestable>(with endpoint: E,
                                         completion: @escaping CompletionHandler<Data?>) -> NetworkCancellable? where E.Response == Void
}
...
extension DefaultDataTransferService: DataTransferService {
    ...
    public func request<E>(with endpoint: E, completion: @escaping CompletionHandler<Data?>) -> NetworkCancellable? where E : ResponseRequestable, E.Response == Void {
        return self.networkService.request(endpoint: endpoint) { result in
            switch result {
            case .success(let data):
